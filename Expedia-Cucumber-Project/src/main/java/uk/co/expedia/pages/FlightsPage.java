...
@FindBy(xpath = "//*[@id=\"gcw-flights-form-hp-flight\"]/div[9]/label/button")
    ...
    public void enterFlyingFrom(String origin) {
        Reporter.addStepLog("Entering flying from : " + origin + " On flying from field : " + _flyingFrom.toString() + "<br>");
    ...
    public void enterGoingTo(String destination) {
        Reporter.addStepLog("Entering going to : " + destination + " On going to field : " + _goingTo.toString() + "<br>");
    ...
    public void enterDepartingDate(String date) {
        Reporter.addStepLog("Entering departing date : " + date + " On departing date field : " + _departing.toString() + "<br>");
    ...
    public void enterReturningDate(String date) {
        Reporter.addStepLog("Entering returning date : " + date + " On returning date field : " + _returning.toString() + "<br>");
    ...
    public void clickOnSearchButton() {
        Reporter.addStepLog("Clicking on search button : " + _searchBtn.toString() + "<br>");
