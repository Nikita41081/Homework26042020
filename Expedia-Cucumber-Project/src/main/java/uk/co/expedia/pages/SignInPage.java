...
@FindBy(id = "gss-signin-incorrect-email-or-password")
    ...
    public void enterEmailAddress(String email) {
        Reporter.addStepLog("Entering email : " + email + " On email address field : " + _emailAddressField.toString() + "<br>");
    ...
    public void enterPassword(String password) {
        Reporter.addStepLog("Entering password : " + password + " On password field : " + _passwordField.toString() + "<br>");
        sendTextToElement(_passwordField, password);
        log.info("Entering password : " + password + " On password field : " + _passwordField.toString());
    }

    public void clickOnSignInButton() {
        Reporter.addStepLog("Clicking on sign in button : " + _signInBtn.toString() + "<br>");
        clickOnElement(_signInBtn);
        log.info("Clicking on sign in button : " + _signInBtn.toString());
    }

    public String getErrorMessage() {
        Reporter.addStepLog("Getting text from error message : " + _errorMessage.toString() + "<br>");
