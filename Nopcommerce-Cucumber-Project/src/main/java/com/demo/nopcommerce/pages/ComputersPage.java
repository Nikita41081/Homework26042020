...
*/
    ...
    public void mouseHoverOnDesktopAndClick(){
        Reporter.addStepLog("Mouse hovering on desktop and click" + _desktopsTab.toString()+"<br>");
        mouseHoverToElementAndClick(_desktopsTab);
        log.info("Mouse hovering on desktop and click" + _desktopsTab.toString());
    }

    public void clickOnBuildYourOwnComputer(){
        Reporter.addStepLog("clicking on build your own computer" + _buildYourOwnComputer.toString()+"<br>");
    ...
    public void clickOnHddRadioButton(){
        Reporter.addStepLog("Clicking on Hdd radio button" + _hddRadioButton.toString()+"<br>");
    ...
    public void clickOnAddToCartButton(){
        Reporter.addStepLog("Clicking on add to cart button" + _addToCart.toString()+"<br>");
        clickOnElement(_addToCart);
        log.info("Clicking on add to cart button" + _addToCart.toString());
    }

    public String addToCartConfirmationText(){
        Reporter.addStepLog("Get add to cart confirmation" + _addedToShoppingCartText.toString()+"<br>");
