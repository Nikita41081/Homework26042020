...
public class BankManagerLoginPage extends Utility {
    ...
    public void clickOnAddCustomerTab(){
        Reporter.addStepLog("Clicking On Add Customer Tab :" + addCustomerTab.toString() + "<br>");
    ...
    public void clickOnOpenAccountTab(){
        Reporter.addStepLog("Clicking On Open Account Tab :" +openAccountTab.toString() + "<br>");
        clickOnElement(openAccountTab);
        log.info("Clicking On Open Account Tab :" +openAccountTab.toString());
    }
    public void clickOnCustomerTab(){
        Reporter.addStepLog("Clicking On Customer Tab :" +customersTab.toString() + "<br>");
