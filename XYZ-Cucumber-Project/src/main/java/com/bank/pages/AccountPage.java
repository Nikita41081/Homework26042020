...
public class AccountPage extends Utility {
    ...
    public void clickOnHomeBt(){
        Reporter.addStepLog("Clicking On Home Button :" + homeBtLink.toString() + "<br>");
        clickOnElement(homeBtLink);
        log.info("Clicking On Home Button :" +homeBtLink.toString());
    }

    public void clickOnDepositButton() {
        Reporter.addStepLog("Clicking On Deposit Button :" +depositLink.toString() + "<br>");
    ...
    public void enterAmountToDeposit(int amount) {
        Reporter.addStepLog("Entering Amount To Deposit : " +amount +"in deposit field : " + amountToBeWithdrawn.toString() + "<br>" );
    ...
    public void clickDepositFeature() {
        Reporter.addStepLog("Clicking on Deposit Button :" +depositButton.toString() + "<br>");
        clickOnElement(depositButton);
        log.info("Clicking on Deposit Button :" +depositButton.toString());
    }

    public String getTextDepositSuccessfulMessage() {
        Reporter.addStepLog("Getting Deposit Successful Message :" + getTextDepositSuccessful.toString() + "<br>");
    ...
    public void clickOnWithdrawalTab() {
        Reporter.addStepLog("Clicking On Withdrawl Tab :" + withdrawalLink.toString() + "<br>");
    ...
    public void enterAmountToWithdrawl( String amount) {
        Reporter.addStepLog("Entering Amount To Withdrawl :" +amount + "in withdrawl field :" + amountToBeWithdrawn.toString() + "<br>" );
    ...
    public String getErrorMessage(){
        Reporter.addStepLog("Getting Error Message :" + errorMessage.toString() + "<br>");
